  ...
  return (
    <div className="w-full max-w-4xl mt-6 pt-4 mx-auto">
      ...
      <div className="flex justify-between items-end mb-2">
        <span className="text-gray-600 font-semibold text-sm">{month} 발주금액</span>
      ...
      <div className="relative">
        ...
        <div className="relative w-full h-8 bg-gray-100 border rounded-lg overflow-hidden shadow-md z-0">
          {/* 사용 예산 (왼쪽) */}
          <div
            className="absolute top-0 left-0 bg-green-600 h-8 flex justify-center items-center text-xs text-white font-semibold z-10 shadow-md"
