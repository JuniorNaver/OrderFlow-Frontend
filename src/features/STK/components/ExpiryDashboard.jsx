...
// STKPage에서 전달받을 onNavigate 함수를 prop으로 추가합니다.
const ExpiryDashboard = ({ onNavigate }) => { 
  ...
  const handleCardClick = (type) => {
    ...
    // 유통기한 만료 카드 클릭 시, '유통기한 마감 상품 관리' 페이지로 이동하도록 요청
    if (type === 'Expired' && onNavigate) {
        // stockMenus 배열에 정의된 '/stk/expired' 경로를 사용합니다.
        onNavigate('/stk/expired'); 
    }
  }
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <div style={styles.gridContainer}>
        ...
        {/* Card 2: 유통기한 만료 상품 -> 클릭 시 상세 페이지로 이동 요청 */}
