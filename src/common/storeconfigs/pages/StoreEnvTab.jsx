    ...
    return (
      <div className="space-y-4 relative">
        ...
        <div className="text-sm text-gray-700 space-y-2 border-t pt-3">
          ...
          <p><strong>지점 유형:</strong> {store.storeType}</p>
          ...
          <p>
            <strong>운영 상태:</strong>{" "}
            {store.active ? (
              <span className="text-green-600 font-semibold">운영중</span>
            ) : (
              <span className="text-gray-400 font-semibold">비활성</span>
            )}
          </p>
